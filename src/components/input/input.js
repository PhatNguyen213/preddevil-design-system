...
let MyInput = (() => {
    var _MyInput_value_accessor_storage;
    let _classDecorators = [customElement("my-input")];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = TwLitElement;
    let _value_decorators;
    let _value_initializers = [];
    let _value_extraInitializers = [];
    var MyInput = _classThis = class extends _classSuper {
        get value() { return __classPrivateFieldGet(this, _MyInput_value_accessor_storage, "f"); }
        set value(value) { __classPrivateFieldSet(this, _MyInput_value_accessor_storage, value, "f"); }
        render() {
            return html `<input
      id="input"
    ...
    />`;
        ...
        constructor() {
            super(...arguments);
            _MyInput_value_accessor_storage.set(this, __runInitializers(this, _value_initializers, "Hello"));
            __runInitializers(this, _value_extraInitializers);
        }
    };
    _MyInput_value_accessor_storage = new WeakMap();
